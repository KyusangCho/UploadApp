    ...
    public class ScheduleData
    {
        ...
        public List<HospitalData> GetHospitalData()
        {
            ...
            hospitalData.Add(new HospitalData
            {
                ...
                Name = "Express",
                StartTime = new DateTime(2020, 1, 6, 9, 0, 0),
                EndTime = new DateTime(2020, 1, 9, 10, 0, 0),
                Description = "Express1",
                DepartmentID = 1,
                ConsultantID = 1,
                DepartmentName = "TEAM1A"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 11,
                Name = "Kohl's",
                StartTime = new DateTime(2020, 1, 16, 10, 30, 0),
                EndTime = new DateTime(2020, 1, 26, 11, 30, 0),
                Description = "Kohl's1",
                DepartmentID = 1,
                ConsultantID = 2,
                DepartmentName = "TEAM2"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 12,
                Name = "Maternity Opco",
                StartTime = new DateTime(2020, 1, 3, 12, 0, 0),
                EndTime = new DateTime(2020, 1, 16, 13, 0, 0),
                Description = "Maternity Opco1",
                DepartmentID = 2,
                ConsultantID = 3,
                DepartmentName = "TEAM2"
            });
            hospitalData.Add(new HospitalData
            {
                ...
                Name = "GUESS",
                StartTime = new DateTime(2020, 1, 6, 14, 0, 0),
                EndTime = new DateTime(2020, 1, 26, 15, 0, 0),
                Description = "GUESS",
                DepartmentID = 2,
                ConsultantID = 4,
                DepartmentName = "TEAM3"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 14,
                Name = "LUCKY OPCO",
                StartTime = new DateTime(2020, 1, 6, 10, 0, 0),
                EndTime = new DateTime(2020, 1, 12, 11, 0, 0),
                Description = "LUCKY OPCO",
                DepartmentID = 3,
                ConsultantID = 5,
                DepartmentName = "TEAM3"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 15,
                Name = "LANDS' END",
                StartTime = new DateTime(2020, 1, 11, 9, 30, 0),
                EndTime = new DateTime(2020, 1, 21, 10, 30, 0),
            ...
            hospitalData.Add(new HospitalData
            {
                ...
                EndTime = new DateTime(2020, 1, 11, 13, 30, 0),
                Description = "J. CREW",
                DepartmentID = 4,
                ConsultantID = 9,
                DepartmentName = "TEAM1"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 18,
            ...
            {
                Id = 19,
                Name = "NAUTICA OPCO LLC",
                StartTime = new DateTime(2020, 1, 3, 16, 30, 0),
                EndTime = new DateTime(2020, 1, 13, 18, 45, 0),
                Description = "NAUTICA OPCO LLC",
                DepartmentID = 5,
                ConsultantID = 1,
                DepartmentName = "TEAM3"
            });
            hospitalData.Add(new HospitalData
            {
                Id = 20,
                Name = "AEO (L&F)",
                StartTime = new DateTime(2020, 1, 5, 19, 30, 0),
                EndTime = new DateTime(2020, 1, 9, 21, 45, 0),
                Description = "AEO (L&F)",
                DepartmentID = 6,
                ConsultantID = 2,
                DepartmentName = "TEAM3"
